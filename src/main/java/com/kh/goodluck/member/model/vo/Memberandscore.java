...
public class Memberandscore implements Serializable{
	...
	public int getSCORE_SELL_RATE() {
		return SCORE_SELL_RATE;
	}

	public void setSCORE_SELL_RATE(int sCORE_SELL_RATE) {
	...
	public Memberandscore(String member_id, String member_pw, String member_name, String member_email,
			...
			String member_refreshtoken, int mEMBER_KAKAOIDPK, int member_keyword_count, String emoticonfile,
			int sCORE_BUY, int sCORE_BUY_COUNT, int sCORE_SELL, int sCORE_SELL_COUNT, int sCORE_SELL_RATE) {
		super();
		this.member_id = member_id;
		this.member_pw = member_pw;
		this.member_name = member_name;
