...
@Component("myPageApplyBoard")
public class MyPageApplyBoard implements Serializable{

	private static final long serialVersionUID = 8267L;
	...
	public MyPageApplyBoard() {
		
	}

	public MyPageApplyBoard(int agency_no, String agency_writer, String agency_title, int link2_no, int agency_type,
			...
			String agency_option, String category_small_name, String trade_applicant, Date trade_date,
			String trade_reservation, Date trade_reservation_date) {
		super();
		...
		this.trade_reservation = trade_reservation;
	...
	public String toString() {
		return "MyPageApplyBoard [agency_no=" + agency_no + ", agency_writer=" + agency_writer + ", agency_title="
				...
				+ agency_option + ", category_small_name=" + category_small_name + ", trade_applicant="
