...
public String toString() {
	return "Cheat [CHATDEATIL_NO=" + CHATDEATIL_NO + ", CHATROOM_NO=" + CHATROOM_NO + ", CHATDEATIL_CONTENT="
			+ CHATDEATIL_CONTENT + ", CHATDEATIL_MEMBER=" + CHATDEATIL_MEMBER + ", CHATDEATIL_DATE=" + CHATDEATIL_DATE
			+ ", CHATROOM_MEMBER1=" + CHATROOM_MEMBER1 + ", CHATROOM_MEMBER2=" + CHATROOM_MEMBER2 + "]";
}
...
public Chat(int cHATDEATIL_NO, int cHATROOM_NO, String cHATDEATIL_CONTENT, String cHATDEATIL_MEMBER,
