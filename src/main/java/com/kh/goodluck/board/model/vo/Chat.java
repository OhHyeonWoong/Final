...
public String toString() {
	return "Chat [CHATDEATIL_NO=" + CHATDEATIL_NO + ", CHATROOM_NO=" + CHATROOM_NO + ", AGENCY_NO=" + AGENCY_NO
			+ ", CHATDEATIL_CONTENT=" + CHATDEATIL_CONTENT + ", CHATDEATIL_MEMBER=" + CHATDEATIL_MEMBER
			+ ", CHATDEATIL_DATE=" + CHATDEATIL_DATE + ", CHATROOM_MEMBER1=" + CHATROOM_MEMBER1 + ", CHATROOM_MEMBER2="
			+ CHATROOM_MEMBER2 + "]";
}
