...
public class KakaoMessageAPI extends Thread{
  ...
  private void sendmessage() {
	...
	try{
	    ...
	    linkObject.put("web_url","127.0.0.1:9999/goodluck/DealingState1.go?BoardNo="+boardno);
	    linkObject.put("mobile_web_url","127.0.0.1:9999/goodluck/DealingState1.go?BoardNo="+boardno);
