...
public class SearchSideBar implements Serializable {
	
	private static final long serialVersionUID = 701101L;
	private int vh_no;
	...
	public SearchSideBar(int vh_no, String member_id, Date vh_date, int agency_no, String agency_writer,
			String agency_title, int link2_no, int agency_type, String agency_loc, Date agency_startdate,
			Date agency_enddate, Date agency_enrolldate, int agency_paytype, int agency_pay, int agency_status,
			String agency_content, int agency_views, String agency_keyword, String agency_option) {
		super();
		this.vh_no = vh_no;
	...
	public String toString() {
		return "SearchResultSideBar [vh_no=" + vh_no + ", member_id=" + member_id + ", vh_date=" + vh_date
				+ ", agency_no=" + agency_no + ", agency_writer=" + agency_writer + ", agency_title=" + agency_title
