					...
					<div class="receipt-header receipt-header-mid">
						<div class="col-xs-8 col-sm-8 col-md-8 text-left">
							<div class="receipt-right">
								<h5>Gurdeep Singh <small>  |   Lucky Number : 156</small><i class="fa fa-phone"></i></h5>
								<p><b>Mobile :</b> +91 12345-6789 <i class="fa fa-envelope-o"></i></p>
								<p><b>Email :</b> info@gmail.com <i class="fa fa-location-arrow"></i></p>
