								...
								<p align="center">
									...
									<c:if test="${ useing.ITEMNAME eq '제목 색상변경권'}">
										...
										<table>
											<tr align="center">
								 				...
								 				<Td style="padding: 2px;"><p style="width: 20px; height: 20px; background-color: red;" /><Br>빨</td><Td><input type="radio" name="title_color" value="red"></Td>
												<Td style="padding: 2px;"><p style="width: 20px; height: 20px; background-color: blue;" /><Br>파</td><Td><input type="radio" name="title_color" value="blue"></Td>
												<Td style="padding: 2px;"><p style="width: 20px; height: 20px; background-color: green;" /><Br>초</td><Td><input type="radio" name="title_color" value="green"></Td>
											</tr>
											<tr  align="center">
												<Td style="padding: 2px;"><p style="width: 20px; height: 20px; background-color: yellow;" /><Br>노</td><Td><input type="radio" name="title_color" value="yellow"></Td>
												<Td style="padding: 2px;"><p style="width: 20px; height: 20px; background-color: pink;" /><Br>핑</td><Td><input type="radio" name="title_color" value="pink"></Td>
												<Td style="padding: 2px;"><p style="width: 20px; height: 20px; background-color: orange;" /><Br>오</td><Td><input type="radio" name="title_color" value="orange"></Td>
											</tr>
										</table>
										<br>
									</c:if>
									...
									<c:if test="${ useing.ITEMNAME eq '제목 굵기강조권'}">
										...
										<table>
											...
											<tr align="center"><td>Yes&nbsp;<input type="radio" name="title_size" value="0"></td><td>No&nbsp;<input type="radio" name="title_bold" value="1"></td></tr>
										</table>
										<br>
									</c:if>
									...
									<c:if test="${ useing.ITEMNAME eq '게시글 프리미엄'}">
										...
										<hr style="clear: both; margin-top: 6px; margin-bottom: 6px; width: 65%;">	
										<table>
											<tr align="center"><td>Yes&nbsp;<input type="radio" name="title_premium" value="0"></td><td>No&nbsp;<input type="radio" name="title_premium" value="1"></td></tr>
										</table>	
										<br>
									</c:if>
