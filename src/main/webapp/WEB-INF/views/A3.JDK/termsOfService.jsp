...
① <독신사>(‘www.doksinsa.com’이하 ‘독신사’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 
...
① <독신사>('www.doksinsa.com'이하 '독신사')은(는) 
...
② <독신사>('www.doksinsa.com'이하 '독신사')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 

위탁업무 수행목적 외 개인정보 처리금지, 
기술적․관리적 보호조치, 
재위탁 제한, 
수탁자에 대한 관리․감독, 
...
① 정보주체는 독신사(‘www.doksinsa.com’이하 ‘독신사) 
에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
1. 개인정보 열람요구
2. 오류 등이 있을 경우 정정 요구
3. 삭제요구
4. 처리정지 요구
...
① 독신사 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠기(cookie)’를 사용합니다. 
...
② 정보주체께서는 독신사(‘www.doksinsa.com’이하 ‘독신사)의 서비스(또는 사업)을 이용하시면서 
발생한 모든 개인정보 보호 관련 문의,불만처리,피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 
독신사(‘www.doksinsa.com’이하 ‘독신사) 은(는)정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
...
11. 개인정보의 안전성 확보 조치 <독신사>('독신사')은(는) 
...
3. 해킹 등에 대비한 기술적 대책
<독신사>('독신사')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 
